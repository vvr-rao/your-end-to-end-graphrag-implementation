...
def entity_extract(
    ...
    *,
    ...
    system = (
        ...
        "  - Do extract named PEOPLE when the passage names them, including "
        "people quoted or cited -- they are frequently the subject of the "
        "passage's actual claim.\n"
...
def entity_validate(
    ...
    system = (
        ...
        "\"wrong_class\".\n"
        "  - missing_entities: only PROPER NOUNS actually written in the "
        "passage that the extractor omitted, and that matter to what the "
        "passage is saying (a person it quotes, an organization it is about). "
        "Years and dates are handled by a separate pass -- never list them.\n"
